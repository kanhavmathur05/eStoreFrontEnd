...
<div class="container col-sm-12 col-xs-12 col-lg-12 col-md-12" style="padding-bottom: 10px;">
<h3 align="center" style="text-decoration: underline;">Enter Product Details</h3>
</div>
